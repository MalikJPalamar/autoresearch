...
SCALAR_LR = 0.60        # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.0      # cautious weight decay for Muon
ADAM_BETAS = (0.05, 0.99) # Adam beta1, beta2
...
while True:
    ...
    torch.nn.utils.clip_grad_norm_(model.parameters(), max_norm=0.10)
    optimizer.step()
...
steady_state_mfu = 100 * num_flops_per_token * TOTAL_BATCH_SIZE * step / total_training_time / H100_BF16_PEAK_FLOPS if total_training_time > 0 else 0
