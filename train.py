...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=x0_params, lr=scalar_lr, betas=(0.5, 0.95), eps=1e-10, weight_decay=0.0),
        ]
...
STABLE_RATIO = 0.60     # fraction of time budget at peak LR (WSD schedule)
...
DEVICE_BATCH_SIZE = 128 if HAS_CUDA else 32  # per-device batch size
