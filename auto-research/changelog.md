...
## Queued Experiments
- **(none queued):** Phase 3 rollout list remains exhausted; no queued item behind format-016.
- **format-016:** Cross-Source Price Divergence Flag — auto-evolve (data presentation) — **ACTIVE since 2026-09-04, report 1/3, baseline_cs=76.00**
