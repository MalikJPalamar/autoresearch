...
## Queued Experiments
- **(none queued):** Phase 3 rollout list remains exhausted; no queued item behind format-017.
- **format-017:** Golden Cross / Death Cross Signal Confirmation Override — auto-evolve (signal-logic, pre-approved 2026-08-20) — **ACTIVE since 2026-09-08, report 2/3 (2026-09-09), 0 overrides fired either report, baseline_cs=76.06 — resolves next report (Sep 10, 3/3)**
