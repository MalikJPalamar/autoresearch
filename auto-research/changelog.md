...
## Queued Experiments
- **(none queued):** Phase 3 rollout list remains exhausted; no queued item behind format-019.
- **format-019:** Analyst Rating Action Confirmation Override — auto-evolve (signal-logic, pre-approved 2026-08-20) — **ACTIVE since 2026-09-15, report 2/3 (2026-09-18), baseline_cs=75.92, running 2-report avg 75.90 (delta -0.02); 2 overrides fired to date (GOOGL, LRCX both WATCH→ACCUMULATE on 2026-09-18)**
